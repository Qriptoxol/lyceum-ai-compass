...
/**
 * CLI Script для назначения роли администратора СУЩЕСТВУЮЩЕМУ пользователю Telegram
 * 
 * ВАЖНО: Этот скрипт назначает роль admin пользователю, который уже зарегистрирован 
 * через Telegram Mini App. Для создания учетной записи веб-админ-панели используйте
 * cli-create-first-admin.js
 * 
 * Использование:
